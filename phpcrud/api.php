...
require_once __DIR__.'/postgresqli.php';
require_once __DIR__.'/sqlitei.php';
require_once __DIR__.'/sqlserveri.php';
...
class PHP_CRUD_API {
	...
	protected function exitWith422($object) {
		if (isset($_SERVER['REQUEST_METHOD'])) {
			...
			die(json_encode($object,JSON_UNESCAPED_UNICODE));
		} else {
			throw new \Exception(json_encode($object,JSON_UNESCAPED_UNICODE));
		}
	}
	...
	protected function readCommand($parameters) {
		...
		$this->startOutput();
		echo json_encode($objectl,JSON_UNESCAPED_UNICODE);
		return false;
	}

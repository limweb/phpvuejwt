...
class TestController
{
    ...
    public function getTlen($id = null,$a=null,$b=null,$c=null) {
        echo 'tlen work';
    }
    /**
     ...
     *
     */
    public function getUser($id = null,$a=null,$b=null,$c=null)
    {
        // if ($id) {
        ...
        return array("id" => $id, "a" =>$a,'b'=>$b ,'c'=>$c); // serializes object into JSON
    }
...
/**
     ...
     @url GET /all/$id
     @url GET /all/current
     @url POST /all/current
     @url OPTIONS /all/current
     @url PUT /all/current
     @url HEAD /all/current
     @url DELETE /all/current
**/
    public function getAll($id=null,$data){
